...
export default function ExpensesByCategoryChart({ chartData, maxBar }: ExpensesByCategoryChartProps) {
   return (
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/3 lg:p-6">
         <h2 className="mb-4 text-lg font-semibold text-gray-800 dark:text-white/90">Chart de Gastos por categoría</h2>
         <div className="space-y-3">
            ...
            {chartData.length === 0 && (
               <p className="text-sm text-gray-500 dark:text-gray-400">Sin datos para pintar el chart.</p>
            )}
         </div>
      </div>
   );
